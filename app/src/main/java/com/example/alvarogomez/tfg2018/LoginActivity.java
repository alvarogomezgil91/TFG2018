...
import com.example.alvarogomez.tfg2018.PresentationActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignInButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                //Crearemos un intent para pasar a la Activity del Sign In
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        //Habria que sacar el hash de la password
        String password = mPasswordView.getText().toString();
        ...
        protected void onPostExecute(Boolean credentialsOK) {
            ...
            if (credentialsOK){
                ...
                if (rememberMe){
                    System.out.println("*************Se ha activado el remember");
                } else{

                    System.out.println("*************No se ha activado el remember**********");
                }
