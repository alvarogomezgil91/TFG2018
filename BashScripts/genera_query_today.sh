...
path_csv="csv_today/${today}/"
path="queries_today/${today}/"
...
rm -f ${path}${fichero_query}
rm -f ${path}${fichero_tecnico_query}

nombre_fichero=$1.csv


if [ ! -f ${path_csv}${nombre_fichero} ] ; then
	echo ${path_csv}${nombre_fichero}
...
do
	...
	echo "DELETE FROM stocks WHERE simbolo = '$1' AND fecha = '${fecha}';" >> ${path}${fichero_query}
	echo "DELETE FROM tecnicos_stocks WHERE simbolo = '$1' AND fecha = '${fecha}';" >> ${path}${fichero_tecnico_query}
	...
	echo ${tecnico} >> ${path_csv}${fichero_tecnico}
	echo ${statement_tecnico} >> ${path}${fichero_tecnico_query}
